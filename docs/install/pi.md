...
- `.pi/extensions/shepherd-pr.ts`, the Pi extension module that registers the plugin's skills directory

## Installing

```
pi install git:github.com/prime-radiant-inc/shepherd-pr
```
